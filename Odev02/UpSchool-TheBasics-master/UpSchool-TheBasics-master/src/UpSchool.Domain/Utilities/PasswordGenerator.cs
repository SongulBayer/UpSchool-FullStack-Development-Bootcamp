...
namespace UpSchool.Domain.Utilities
{
    public class PasswordGenerator
    {
        ...
        public string Generate(GeneratePasswordDto generatePasswordDto)
        {
            ...
            //if (!generatePasswordDto.IncludeNumbers && !generatePasswordDto.IncludeLowercaseCharacters && !generatePasswordDto.IncludeUppercaseCharacters
            //    && !generatePasswordDto.IncludeUppercaseCharacters)
            if(generatePasswordDto is 
                { IncludeLowercaseCharacters:false,IncludeNumbers:false,IncludeSpecialCharacters:false,IncludeUppercaseCharacters:false})
            {
                return string.Empty;
            }
